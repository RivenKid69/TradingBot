...
def main():
    ...
    ap.add_argument("--realtime_config", default="configs/realtime.yaml", help="Файл для чтения min_signal_gap_s (если не задан явно).")
    ap.add_argument("--sandbox_config", default="configs/sandbox.yaml", help="Файл с no_trade (если нужно фильтровать).")
    ap.add_argument("--drop_no_trade", action="store_true", help="Фильтровать no-trade окна (по sandbox.yaml).")
